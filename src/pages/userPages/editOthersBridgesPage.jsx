...
function EditOthersBridgesPage() {
  ...
  function handleSubmit(e) {
    ...
    const novoJson = {
      id: "bridges-principal",
      titulo: data.bridges.titulo,
      conteudo: parseContent(bridgesText),
    };
      ...
      <ContentComponent>
        <form className="userForms" onSubmit={handleSubmit}>
          <h3 id="addArticleTitle">
            Editar página Bridges
          </h3>

          <p style={{ fontSize: "0.85rem", opacity: 0.8 }}>
            💡 Parágrafo: ENTER duplo <br />
            🖼 Imagem: [[img:/bridgeImages/brid1.png]]
          </p>
...
export default EditOthersBridgesPage;