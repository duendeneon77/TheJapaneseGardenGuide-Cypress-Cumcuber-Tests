export default{
    editWaterSessionPage(){
    cy.contains('h3', 'Editar página Water',{timeout:5000}).should('be.visible')
    cy.get('#textHistory').click().type("{end}\n\n [[img:/testImages/testimage.png]]")
    cy.get('#textHistory').click().type("{end}\n\nEDIT-WATER-SESSION-TEST-TEXT")
    },
    saveTheEdition(){
    ...
    cleanupWaterSessionPage() {
    const imageTag = "[[img:/testImages/testImage.png]]"
    const testText = "EDIT-WATER-SESSION-TEST-TEXT"
